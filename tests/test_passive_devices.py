...
class TestPassiveDeviceEKFIntegration:
    ...
    @pytest.mark.asyncio
    async def test_passive_cooling_active_sets_ekf_mode_to_cooling(self, hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_passive_cooling_inactive_ekf_mode_is_idle(self, hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_own_device_heating_passive_cooling_ignored(self, hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_passive_cooling_pf_stored_in_accumulator(self, hass, mock_config_entry):
    ...
    @pytest.mark.asyncio
    async def test_two_passive_cooling_devices_pf_summed(self, hass, mock_config_entry):
        ...
        def _states(entity_id):
            ...
            if entity_id == "climate.room_a_heater":
                s = MagicMock()
                s.state = "heat_cool"
                s.attributes = {"hvac_action": "idle", "current_temperature": 23.0}
                return s
